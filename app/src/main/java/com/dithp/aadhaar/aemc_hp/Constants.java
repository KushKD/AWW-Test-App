...
public class Constants {
    ...
    // Key Removed From VCS
    public static final String url_Generic = "http://10.0.2.2:8008/RestServiceImpl.svc";
    ...
    public static final String URL_BASE = "http://10.0.2.2:8008/RestServiceImpl.svc/saveDetails";
    ...
    public static final String PError1 = "Enter a Valid Phone Number";
